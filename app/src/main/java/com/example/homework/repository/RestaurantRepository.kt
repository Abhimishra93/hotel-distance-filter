...
object RestaurantRepository {
    ...
    fun fetchRestaurants(term: String?, location: String?, radius: Int?): Flow<Callback> {
        return flow {
            val response = RetrofitClient.get(RestaurantService::class.java).fetchRestaurant(term, location,radius)
